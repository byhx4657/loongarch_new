...
HD_PWD='d:/NSCSCC/loongarch/cdp_ede_local-master-pipelinecpu_sdu/mycpu_env/soc_verify/soc_bram/run_vivado/project/loongson.runs/my_div_u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_div_u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_div_u.tcl
